...
RUN curl -L https://sourceforge.net/projects/logicaldoc/files/distribution/LogicalDOC%20CE%208.2/logicaldoc-community-installer-${LDOC_VERSION}.zip/download \
